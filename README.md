...
- **Web 配置面板**：界面内直接设置 API Key、model、DPI、并发数和 prompt，无需手动改配置文件。
...
配置行为参数，修改后重启生效；也可在 Web 配置面板中实时调整：
...
- 个人学习、研究、非商业用途：自由使用和修改。
- **网络服务 / 商业用途**：若将本项目（含修改版本）用于对外提供服务或商业变现，须以同样的 AGPL-3.0 协议开源你的完整代码。
- 如需**闭源集成或商业授权**，请通过 GitHub Issues 联系作者获取单独授权。